...
use App\Filament\Resources\ForPaymentProcessingReimbursementResource\Pages;
...
class ForPaymentProcessingReimbursementResource extends Resource
{
    protected static ?string $model = ForPaymentProcessing::class;
    protected static ?string $navigationGroup = 'Reimbursements';
    protected static ?string $navigationLabel = 'For Payment Processing';
    protected static ?string $slug = 'for-payment-processing-reimbursements';
    ...
    {
        return [
            'index' => Pages\ListForPaymentProcessingReimbursements::route('/'),
            'create' => Pages\CreateForPaymentProcessingReimbursement::route('/create'),
            'edit' => Pages\EditForPaymentProcessingReimbursement::route('/{record}/edit'),
            'view' => Pages\ViewForPaymentProcessingReimbursement::route('/{record}/view'),
        ];
    }

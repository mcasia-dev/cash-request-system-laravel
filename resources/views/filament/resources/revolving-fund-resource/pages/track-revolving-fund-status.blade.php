<x-filament-panels::page>
    ...
    <div class="timeline">
        <div class="step">
            ...
            <div class="step-top">
                <h2 class="step-head">{{ $this->getRecord()->fund_code }}</h2>
                <span class="step-pill intro-pill">{{ $this->getRecord()->status_remarks ?? 'Revolving Fund' }}</span>
            </div>
        </div>
